...
<hr>
    <div class="" id = "agregarAnualidad" style="display:none">
      ...
      <input type="button" name="agregarAnualidad" onclick="cancelar()" value="Cancelar">
    </div>
    <a><input type="button" name="agregarAnualidad" onclick="agregarNuevaAnualidad()" value="Nueva Anualidad"></a>
