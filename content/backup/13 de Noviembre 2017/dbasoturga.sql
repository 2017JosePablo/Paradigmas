...
--
-- Host: localhost
-- Generation Time: Nov 14, 2017 at 01:47 AM
...
(2, 2, 0, '0000-00-00', 'Aceptado', 'Solicitud Aceptada.');
...
(1, 2, '../uploads/fierros/Junta.png', 2);
...
--
-- Dumping data for table `tbpastoforraje`
--

INSERT INTO `tbpastoforraje` (`idpastoforraje`, `pastoforrajenombre`) VALUES
(1, 'Sin datos');
...
(2, 'Junta', 'Primer', 'Nombrekj', 'Res', '1831 85 20', 'ja@fm.com', 1, 1, '2017-06-11', 2, 'Sin Recomendacion', 'Sin Recomendacion', 'Sin responsable', 'Sin beneiciario');
...
(2, 'Lecher&iacutea doble prop&oacutesito'),
(3, 'Cría'),
(4, 'Engorde'),
...
--
-- Indexes for table `tbpastocorte`
--
ALTER TABLE `tbpastocorte`
  ADD PRIMARY KEY (`idpastocorte`);

--
-- Indexes for table `tbpastoforraje`
--
...
--
ALTER TABLE `tbcvo`
  MODIFY `cvoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `tbfincacerca`
  MODIFY `fincacercaid` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- AUTO_INCREMENT for table `tbpastocorte`
--
ALTER TABLE `tbpastocorte`
  MODIFY `idpastocorte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tbpastoforraje`
--
ALTER TABLE `tbpastoforraje`
  MODIFY `idpastoforraje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
